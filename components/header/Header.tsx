                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            ...
                            <a href="https://flowbite-admin-dashboard.vercel.app/" className="flex ml-2 md:mr-24">
                                <Image
                                    ...
                                    className="h-8 mr-3"
                                    alt="FlowBite Logo" />
                                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">MSI</span>
                            </a>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown" data-popper-placement="bottom" style={{ "position": "absolute", "inset": "0px auto auto 0px", "margin": "0px", "transform": "translate(1739px, 65px)" }}>
                            ...
                            <div className="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown" data-popper-placement="bottom" style={{ "position": "absolute", "inset": "0px auto auto 0px", "margin": "0px", "transform": "translate(1779px, 65px)" }}>
                                <div className="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    Apps
                                </div>
                            ...
                            <div id="tooltip-toggle" role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip" data-popper-placement="bottom" style={{ "position": "absolute", "inset": "0px auto auto 0px", "margin": "0px", "transform": "translate(1747px, 63px)" }}>
                                Toggle dark mode
                            ...
                            <div className="flex items-center ml-3">
                                ...
                                <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2" data-popper-placement="bottom" style={{ "position": "absolute", "inset": "0px auto auto 0px", "margin": "0px", "transform": "translate(1867px, 61px)" }}>
